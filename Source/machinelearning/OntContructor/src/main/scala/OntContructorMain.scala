...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val ontology = manager.createOntology(IRI.create(ONTOLOGYURI, "schooling#"))
    //Prefix for all the entities
    val pm = new DefaultPrefixManager(null, null, ONTOLOGYURI + "schooling#")
    ...
    val os = new FileOutputStream("data/schooling.owl")
